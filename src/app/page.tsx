...
export default function Home() {
  ...
  const renderGameState = () => {
    switch(gameState) {
      ...
      case 'game-over':
        return (
          <div className="flex h-screen w-screen flex-col items-center justify-center p-4 gap-2">
            <h1 className="font-headline text-4xl font-bold tracking-tighter" style={{ color: '#39FF14', textShadow: '0 0 10px #39FF14' }}>
              Neon Slider
            </h1>
